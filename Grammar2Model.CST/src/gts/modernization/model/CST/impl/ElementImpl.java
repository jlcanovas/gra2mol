 ...
 * </copyright>
 *
 * $Id: ElementImpl.java,v 1.1 2008/01/14 09:09:08 Javier Canovas Exp $
 */
...
public class ElementImpl extends EObjectImpl implements Element {
	...
	public void setKind(String newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSTPackage.ELEMENT__KIND, oldKind, kind));
	}
