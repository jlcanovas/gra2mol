...
public class QuerySwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case QueryPackage.QUERY_CONTROL_GREATER: {
				QueryControlGreater queryControlGreater = (QueryControlGreater)theEObject;
				T result = caseQueryControlGreater(queryControlGreater);
				if (result == null) result = caseQueryControl(queryControlGreater);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QueryPackage.QUERY_CONTROL_EXTENSION: {
				QueryControlExtension queryControlExtension = (QueryControlExtension)theEObject;
				T result = caseQueryControlExtension(queryControlExtension);
				if (result == null) result = caseQueryControl(queryControlExtension);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Control Greater</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Control Greater</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseQueryControlGreater(QueryControlGreater object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Control Extension</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Control Extension</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseQueryControlExtension(QueryControlExtension object) {
		return null;
	}
