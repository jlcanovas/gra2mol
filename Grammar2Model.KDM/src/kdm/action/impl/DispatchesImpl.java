 ...
 * <ul>
 *   <li>{@link kdm.action.impl.DispatchesImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link kdm.action.impl.DispatchesImpl#getTaggedValue <em>Tagged Value</em>}</li>
 ...
 * @generated
 */
public class DispatchesImpl extends ElementImpl implements Dispatches {
	/**
	...
	public EList<Stereotype> getStereotype() {
		if (stereotype == null) {
			stereotype = new EObjectResolvingEList<Stereotype>(Stereotype.class, this, ActionPackage.DISPATCHES__STEREOTYPE);
		}
		return stereotype;
	}
	...
	public EList<ExtendedValue> getTaggedValue() {
		if (taggedValue == null) {
			taggedValue = new EObjectContainmentEList<ExtendedValue>(ExtendedValue.class, this, ActionPackage.DISPATCHES__TAGGED_VALUE);
		}
		return taggedValue;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActionPackage.DISPATCHES__TAGGED_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActionPackage.DISPATCHES__STEREOTYPE:
