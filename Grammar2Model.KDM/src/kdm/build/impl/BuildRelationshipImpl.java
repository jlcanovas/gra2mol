 ...
 * <ul>
 *   <li>{@link kdm.build.impl.BuildRelationshipImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link kdm.build.impl.BuildRelationshipImpl#getTaggedValue <em>Tagged Value</em>}</li>
 ...
 * @generated
 */
public class BuildRelationshipImpl extends ElementImpl implements BuildRelationship {
	/**
	...
	public EList<Stereotype> getStereotype() {
		if (stereotype == null) {
			stereotype = new EObjectResolvingEList<Stereotype>(Stereotype.class, this, BuildPackage.BUILD_RELATIONSHIP__STEREOTYPE);
		}
		return stereotype;
	}
	...
	public EList<ExtendedValue> getTaggedValue() {
		if (taggedValue == null) {
			taggedValue = new EObjectContainmentEList<ExtendedValue>(ExtendedValue.class, this, BuildPackage.BUILD_RELATIONSHIP__TAGGED_VALUE);
		}
		return taggedValue;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BuildPackage.BUILD_RELATIONSHIP__TAGGED_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BuildPackage.BUILD_RELATIONSHIP__STEREOTYPE:
