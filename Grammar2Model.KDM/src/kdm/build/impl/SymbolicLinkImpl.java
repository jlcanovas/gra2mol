 ...
 * <ul>
 *   <li>{@link kdm.build.impl.SymbolicLinkImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link kdm.build.impl.SymbolicLinkImpl#getTaggedValue <em>Tagged Value</em>}</li>
 *   <li>{@link kdm.build.impl.SymbolicLinkImpl#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public class SymbolicLinkImpl extends ElementImpl implements SymbolicLink {
	/**
	...
	public EList<Stereotype> getStereotype() {
		if (stereotype == null) {
			stereotype = new EObjectResolvingEList<Stereotype>(Stereotype.class, this, BuildPackage.SYMBOLIC_LINK__STEREOTYPE);
		}
		return stereotype;
	}
	...
	public EList<ExtendedValue> getTaggedValue() {
		if (taggedValue == null) {
			taggedValue = new EObjectContainmentEList<ExtendedValue>(ExtendedValue.class, this, BuildPackage.SYMBOLIC_LINK__TAGGED_VALUE);
		}
		return taggedValue;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BuildPackage.SYMBOLIC_LINK__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BuildPackage.SYMBOLIC_LINK__TAGGED_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BuildPackage.SYMBOLIC_LINK__STEREOTYPE:
				return getStereotype();
			case BuildPackage.SYMBOLIC_LINK__TAGGED_VALUE:
				return getTaggedValue();
			case BuildPackage.SYMBOLIC_LINK__NAME:
				return getName();
			case BuildPackage.SYMBOLIC_LINK__BUILD_RELATION:
