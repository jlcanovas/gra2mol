 ...
 * <ul>
 *   <li>{@link kdm.code.impl.ExpandsImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link kdm.code.impl.ExpandsImpl#getTaggedValue <em>Tagged Value</em>}</li>
 ...
 * @generated
 */
public class ExpandsImpl extends ElementImpl implements Expands {
	/**
	...
	public EList<Stereotype> getStereotype() {
		if (stereotype == null) {
			stereotype = new EObjectResolvingEList<Stereotype>(Stereotype.class, this, CodePackage.EXPANDS__STEREOTYPE);
		}
		return stereotype;
	}
	...
	public EList<ExtendedValue> getTaggedValue() {
		if (taggedValue == null) {
			taggedValue = new EObjectContainmentEList<ExtendedValue>(ExtendedValue.class, this, CodePackage.EXPANDS__TAGGED_VALUE);
		}
		return taggedValue;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CodePackage.EXPANDS__TAGGED_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CodePackage.EXPANDS__STEREOTYPE:
