 ...
 * <ul>
 *   <li>{@link kdm.code.impl.ParameterToImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link kdm.code.impl.ParameterToImpl#getTaggedValue <em>Tagged Value</em>}</li>
 ...
 * @generated
 */
public class ParameterToImpl extends ElementImpl implements ParameterTo {
	/**
	...
	public EList<Stereotype> getStereotype() {
		if (stereotype == null) {
			stereotype = new EObjectResolvingEList<Stereotype>(Stereotype.class, this, CodePackage.PARAMETER_TO__STEREOTYPE);
		}
		return stereotype;
	}
	...
	public EList<ExtendedValue> getTaggedValue() {
		if (taggedValue == null) {
			taggedValue = new EObjectContainmentEList<ExtendedValue>(ExtendedValue.class, this, CodePackage.PARAMETER_TO__TAGGED_VALUE);
		}
		return taggedValue;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CodePackage.PARAMETER_TO__TAGGED_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CodePackage.PARAMETER_TO__STEREOTYPE:
