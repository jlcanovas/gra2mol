 ...
 * <ul>
 *   <li>{@link kdm.code.impl.VariantToImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link kdm.code.impl.VariantToImpl#getTaggedValue <em>Tagged Value</em>}</li>
 ...
 * @generated
 */
public class VariantToImpl extends ElementImpl implements VariantTo {
	/**
	...
	public EList<Stereotype> getStereotype() {
		if (stereotype == null) {
			stereotype = new EObjectResolvingEList<Stereotype>(Stereotype.class, this, CodePackage.VARIANT_TO__STEREOTYPE);
		}
		return stereotype;
	}
	...
	public EList<ExtendedValue> getTaggedValue() {
		if (taggedValue == null) {
			taggedValue = new EObjectContainmentEList<ExtendedValue>(ExtendedValue.class, this, CodePackage.VARIANT_TO__TAGGED_VALUE);
		}
		return taggedValue;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CodePackage.VARIANT_TO__TAGGED_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CodePackage.VARIANT_TO__STEREOTYPE:
