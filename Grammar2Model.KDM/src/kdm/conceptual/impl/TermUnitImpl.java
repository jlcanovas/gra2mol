 ...
 * <ul>
 *   <li>{@link kdm.conceptual.impl.TermUnitImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link kdm.conceptual.impl.TermUnitImpl#getTaggedValue <em>Tagged Value</em>}</li>
 *   <li>{@link kdm.conceptual.impl.TermUnitImpl#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public class TermUnitImpl extends ElementImpl implements TermUnit {
	/**
	...
	public EList<Stereotype> getStereotype() {
		if (stereotype == null) {
			stereotype = new EObjectResolvingEList<Stereotype>(Stereotype.class, this, ConceptualPackage.TERM_UNIT__STEREOTYPE);
		}
		return stereotype;
	}
	...
	public EList<ExtendedValue> getTaggedValue() {
		if (taggedValue == null) {
			taggedValue = new EObjectContainmentEList<ExtendedValue>(ExtendedValue.class, this, ConceptualPackage.TERM_UNIT__TAGGED_VALUE);
		}
		return taggedValue;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConceptualPackage.TERM_UNIT__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ConceptualPackage.TERM_UNIT__TAGGED_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ConceptualPackage.TERM_UNIT__STEREOTYPE:
				return getStereotype();
			case ConceptualPackage.TERM_UNIT__TAGGED_VALUE:
				return getTaggedValue();
			case ConceptualPackage.TERM_UNIT__NAME:
				return getName();
			case ConceptualPackage.TERM_UNIT__SOURCE:
				return getSource();
