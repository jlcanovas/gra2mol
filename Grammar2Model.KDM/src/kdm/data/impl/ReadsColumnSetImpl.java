 ...
 * <ul>
 *   <li>{@link kdm.data.impl.ReadsColumnSetImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link kdm.data.impl.ReadsColumnSetImpl#getTaggedValue <em>Tagged Value</em>}</li>
 ...
 * @generated
 */
public class ReadsColumnSetImpl extends ElementImpl implements ReadsColumnSet {
	/**
	...
	public EList<Stereotype> getStereotype() {
		if (stereotype == null) {
			stereotype = new EObjectResolvingEList<Stereotype>(Stereotype.class, this, DataPackage.READS_COLUMN_SET__STEREOTYPE);
		}
		return stereotype;
	}
	...
	public EList<ExtendedValue> getTaggedValue() {
		if (taggedValue == null) {
			taggedValue = new EObjectContainmentEList<ExtendedValue>(ExtendedValue.class, this, DataPackage.READS_COLUMN_SET__TAGGED_VALUE);
		}
		return taggedValue;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DataPackage.READS_COLUMN_SET__TAGGED_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataPackage.READS_COLUMN_SET__STEREOTYPE:
