 ...
 * <ul>
 *   <li>{@link kdm.event.impl.EventResourceImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link kdm.event.impl.EventResourceImpl#getTaggedValue <em>Tagged Value</em>}</li>
 *   <li>{@link kdm.event.impl.EventResourceImpl#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public class EventResourceImpl extends ElementImpl implements EventResource {
	/**
	...
	public EList<Stereotype> getStereotype() {
		if (stereotype == null) {
			stereotype = new EObjectResolvingEList<Stereotype>(Stereotype.class, this, EventPackage.EVENT_RESOURCE__STEREOTYPE);
		}
		return stereotype;
	}
	...
	public EList<ExtendedValue> getTaggedValue() {
		if (taggedValue == null) {
			taggedValue = new EObjectContainmentEList<ExtendedValue>(ExtendedValue.class, this, EventPackage.EVENT_RESOURCE__TAGGED_VALUE);
		}
		return taggedValue;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventPackage.EVENT_RESOURCE__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EventPackage.EVENT_RESOURCE__TAGGED_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EventPackage.EVENT_RESOURCE__STEREOTYPE:
				return getStereotype();
			case EventPackage.EVENT_RESOURCE__TAGGED_VALUE:
				return getTaggedValue();
			case EventPackage.EVENT_RESOURCE__NAME:
				return getName();
			case EventPackage.EVENT_RESOURCE__SOURCE:
				return getSource();
			case EventPackage.EVENT_RESOURCE__EVENT_RELATION:
