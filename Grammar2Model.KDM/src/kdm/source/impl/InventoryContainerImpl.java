 ...
 * <ul>
 *   <li>{@link kdm.source.impl.InventoryContainerImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link kdm.source.impl.InventoryContainerImpl#getTaggedValue <em>Tagged Value</em>}</li>
 *   <li>{@link kdm.source.impl.InventoryContainerImpl#getName <em>Name</em>}</li>
 *   <li>{@link kdm.source.impl.InventoryContainerImpl#getInventoryRelation <em>Inventory Relation</em>}</li>
 ...
 * @generated
 */
public class InventoryContainerImpl extends ElementImpl implements InventoryContainer {
	/**
	...
	public EList<Stereotype> getStereotype() {
		if (stereotype == null) {
			stereotype = new EObjectResolvingEList<Stereotype>(Stereotype.class, this, SourcePackage.INVENTORY_CONTAINER__STEREOTYPE);
		}
		return stereotype;
	}
	...
	public EList<ExtendedValue> getTaggedValue() {
		if (taggedValue == null) {
			taggedValue = new EObjectContainmentEList<ExtendedValue>(ExtendedValue.class, this, SourcePackage.INVENTORY_CONTAINER__TAGGED_VALUE);
		}
		return taggedValue;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SourcePackage.INVENTORY_CONTAINER__NAME, oldName, name));
	}
	...
	public EList<AbstractInventoryRelationship> getInventoryRelation() {
		if (inventoryRelation == null) {
			inventoryRelation = new EObjectContainmentEList<AbstractInventoryRelationship>(AbstractInventoryRelationship.class, this, SourcePackage.INVENTORY_CONTAINER__INVENTORY_RELATION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SourcePackage.INVENTORY_CONTAINER__TAGGED_VALUE:
				return ((InternalEList<?>)getTaggedValue()).basicRemove(otherEnd, msgs);
			case SourcePackage.INVENTORY_CONTAINER__INVENTORY_RELATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SourcePackage.INVENTORY_CONTAINER__STEREOTYPE:
				return getStereotype();
			case SourcePackage.INVENTORY_CONTAINER__TAGGED_VALUE:
				return getTaggedValue();
			case SourcePackage.INVENTORY_CONTAINER__NAME:
				return getName();
			case SourcePackage.INVENTORY_CONTAINER__INVENTORY_RELATION:
