 ...
 * <ul>
 *   <li>{@link kdm.structure.impl.ComponentImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link kdm.structure.impl.ComponentImpl#getTaggedValue <em>Tagged Value</em>}</li>
 *   <li>{@link kdm.structure.impl.ComponentImpl#getName <em>Name</em>}</li>
...
public class ComponentImpl extends ElementImpl implements Component {
	...
	public EList<Stereotype> getStereotype() {
		if (stereotype == null) {
			stereotype = new EObjectResolvingEList<Stereotype>(Stereotype.class, this, StructurePackage.COMPONENT__STEREOTYPE);
		}
		return stereotype;
	}
	...
	public EList<ExtendedValue> getTaggedValue() {
		if (taggedValue == null) {
			taggedValue = new EObjectContainmentEList<ExtendedValue>(ExtendedValue.class, this, StructurePackage.COMPONENT__TAGGED_VALUE);
		}
		return taggedValue;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructurePackage.COMPONENT__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StructurePackage.COMPONENT__TAGGED_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StructurePackage.COMPONENT__STEREOTYPE:
				return getStereotype();
			case StructurePackage.COMPONENT__TAGGED_VALUE:
				return getTaggedValue();
			case StructurePackage.COMPONENT__NAME:
				return getName();
			case StructurePackage.COMPONENT__AGGREGATED:
