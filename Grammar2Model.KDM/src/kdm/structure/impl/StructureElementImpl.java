 ...
 * <ul>
 *   <li>{@link kdm.structure.impl.StructureElementImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link kdm.structure.impl.StructureElementImpl#getTaggedValue <em>Tagged Value</em>}</li>
 *   <li>{@link kdm.structure.impl.StructureElementImpl#getName <em>Name</em>}</li>
...
public class StructureElementImpl extends ElementImpl implements StructureElement {
	...
	public EList<Stereotype> getStereotype() {
		if (stereotype == null) {
			stereotype = new EObjectResolvingEList<Stereotype>(Stereotype.class, this, StructurePackage.STRUCTURE_ELEMENT__STEREOTYPE);
		}
		return stereotype;
	}
	...
	public EList<ExtendedValue> getTaggedValue() {
		if (taggedValue == null) {
			taggedValue = new EObjectContainmentEList<ExtendedValue>(ExtendedValue.class, this, StructurePackage.STRUCTURE_ELEMENT__TAGGED_VALUE);
		}
		return taggedValue;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructurePackage.STRUCTURE_ELEMENT__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StructurePackage.STRUCTURE_ELEMENT__TAGGED_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StructurePackage.STRUCTURE_ELEMENT__STEREOTYPE:
				return getStereotype();
			case StructurePackage.STRUCTURE_ELEMENT__TAGGED_VALUE:
				return getTaggedValue();
			case StructurePackage.STRUCTURE_ELEMENT__NAME:
				return getName();
			case StructurePackage.STRUCTURE_ELEMENT__AGGREGATED:
