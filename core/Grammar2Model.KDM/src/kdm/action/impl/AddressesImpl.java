 ...
 * <ul>
 *   <li>{@link kdm.action.impl.AddressesImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link kdm.action.impl.AddressesImpl#getTaggedValue <em>Tagged Value</em>}</li>
 ...
 * @generated
 */
public class AddressesImpl extends ElementImpl implements Addresses {
	/**
	...
	public EList<Stereotype> getStereotype() {
		if (stereotype == null) {
			stereotype = new EObjectResolvingEList<Stereotype>(Stereotype.class, this, ActionPackage.ADDRESSES__STEREOTYPE);
		}
		return stereotype;
	}
	...
	public EList<ExtendedValue> getTaggedValue() {
		if (taggedValue == null) {
			taggedValue = new EObjectContainmentEList<ExtendedValue>(ExtendedValue.class, this, ActionPackage.ADDRESSES__TAGGED_VALUE);
		}
		return taggedValue;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActionPackage.ADDRESSES__TAGGED_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActionPackage.ADDRESSES__STEREOTYPE:
