 ...
 * <ul>
 *   <li>{@link kdm.build.impl.SupplierImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link kdm.build.impl.SupplierImpl#getTaggedValue <em>Tagged Value</em>}</li>
 *   <li>{@link kdm.build.impl.SupplierImpl#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public class SupplierImpl extends ElementImpl implements Supplier {
	/**
	...
	public EList<Stereotype> getStereotype() {
		if (stereotype == null) {
			stereotype = new EObjectResolvingEList<Stereotype>(Stereotype.class, this, BuildPackage.SUPPLIER__STEREOTYPE);
		}
		return stereotype;
	}
	...
	public EList<ExtendedValue> getTaggedValue() {
		if (taggedValue == null) {
			taggedValue = new EObjectContainmentEList<ExtendedValue>(ExtendedValue.class, this, BuildPackage.SUPPLIER__TAGGED_VALUE);
		}
		return taggedValue;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BuildPackage.SUPPLIER__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BuildPackage.SUPPLIER__TAGGED_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BuildPackage.SUPPLIER__STEREOTYPE:
				return getStereotype();
			case BuildPackage.SUPPLIER__TAGGED_VALUE:
				return getTaggedValue();
			case BuildPackage.SUPPLIER__NAME:
				return getName();
			case BuildPackage.SUPPLIER__BUILD_RELATION:
