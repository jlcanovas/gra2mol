 ...
 * <ul>
 *   <li>{@link kdm.code.impl.ModuleImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link kdm.code.impl.ModuleImpl#getTaggedValue <em>Tagged Value</em>}</li>
 *   <li>{@link kdm.code.impl.ModuleImpl#getName <em>Name</em>}</li>
 *   <li>{@link kdm.code.impl.ModuleImpl#getSource <em>Source</em>}</li>
 *   <li>{@link kdm.code.impl.ModuleImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link kdm.code.impl.ModuleImpl#getCodeRelation <em>Code Relation</em>}</li>
...
public class ModuleImpl extends ElementImpl implements Module {
	...
	public EList<Stereotype> getStereotype() {
		if (stereotype == null) {
			stereotype = new EObjectResolvingEList<Stereotype>(Stereotype.class, this, CodePackage.MODULE__STEREOTYPE);
		}
		return stereotype;
	}
	...
	public EList<ExtendedValue> getTaggedValue() {
		if (taggedValue == null) {
			taggedValue = new EObjectContainmentEList<ExtendedValue>(ExtendedValue.class, this, CodePackage.MODULE__TAGGED_VALUE);
		}
		return taggedValue;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodePackage.MODULE__NAME, oldName, name));
	}
	...
	public EList<SourceRef> getSource() {
		if (source == null) {
			source = new EObjectContainmentEList<SourceRef>(SourceRef.class, this, CodePackage.MODULE__SOURCE);
		}
		return source;
	}
	...
	public EList<CommentUnit> getComment() {
		if (comment == null) {
			comment = new EObjectContainmentEList<CommentUnit>(CommentUnit.class, this, CodePackage.MODULE__COMMENT);
		}
		return comment;
	}
	...
	public EList<AbstractCodeRelationship> getCodeRelation() {
		if (codeRelation == null) {
			codeRelation = new EObjectContainmentEList<AbstractCodeRelationship>(AbstractCodeRelationship.class, this, CodePackage.MODULE__CODE_RELATION);
		}
		return codeRelation;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CodePackage.MODULE__TAGGED_VALUE:
				return ((InternalEList<?>)getTaggedValue()).basicRemove(otherEnd, msgs);
			case CodePackage.MODULE__SOURCE:
				return ((InternalEList<?>)getSource()).basicRemove(otherEnd, msgs);
			case CodePackage.MODULE__COMMENT:
				return ((InternalEList<?>)getComment()).basicRemove(otherEnd, msgs);
			case CodePackage.MODULE__CODE_RELATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CodePackage.MODULE__STEREOTYPE:
				return getStereotype();
			case CodePackage.MODULE__TAGGED_VALUE:
				return getTaggedValue();
			case CodePackage.MODULE__NAME:
				return getName();
			case CodePackage.MODULE__SOURCE:
				return getSource();
			case CodePackage.MODULE__COMMENT:
