 ...
 * <ul>
 *   <li>{@link kdm.code.impl.TemplateUnitImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link kdm.code.impl.TemplateUnitImpl#getTaggedValue <em>Tagged Value</em>}</li>
 *   <li>{@link kdm.code.impl.TemplateUnitImpl#getName <em>Name</em>}</li>
 *   <li>{@link kdm.code.impl.TemplateUnitImpl#getSource <em>Source</em>}</li>
 *   <li>{@link kdm.code.impl.TemplateUnitImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link kdm.code.impl.TemplateUnitImpl#getCodeRelation <em>Code Relation</em>}</li>
 ...
 * @generated
 */
public class TemplateUnitImpl extends ElementImpl implements TemplateUnit {
	/**
	...
	public EList<Stereotype> getStereotype() {
		if (stereotype == null) {
			stereotype = new EObjectResolvingEList<Stereotype>(Stereotype.class, this, CodePackage.TEMPLATE_UNIT__STEREOTYPE);
		}
		return stereotype;
	}
	...
	public EList<ExtendedValue> getTaggedValue() {
		if (taggedValue == null) {
			taggedValue = new EObjectContainmentEList<ExtendedValue>(ExtendedValue.class, this, CodePackage.TEMPLATE_UNIT__TAGGED_VALUE);
		}
		return taggedValue;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodePackage.TEMPLATE_UNIT__NAME, oldName, name));
	}
	...
	public EList<SourceRef> getSource() {
		if (source == null) {
			source = new EObjectContainmentEList<SourceRef>(SourceRef.class, this, CodePackage.TEMPLATE_UNIT__SOURCE);
		}
		return source;
	}
	...
	public EList<CommentUnit> getComment() {
		if (comment == null) {
			comment = new EObjectContainmentEList<CommentUnit>(CommentUnit.class, this, CodePackage.TEMPLATE_UNIT__COMMENT);
		}
		return comment;
	}
	...
	public EList<AbstractCodeRelationship> getCodeRelation() {
		if (codeRelation == null) {
			codeRelation = new EObjectContainmentEList<AbstractCodeRelationship>(AbstractCodeRelationship.class, this, CodePackage.TEMPLATE_UNIT__CODE_RELATION);
		}
		return codeRelation;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CodePackage.TEMPLATE_UNIT__TAGGED_VALUE:
				return ((InternalEList<?>)getTaggedValue()).basicRemove(otherEnd, msgs);
			case CodePackage.TEMPLATE_UNIT__SOURCE:
				return ((InternalEList<?>)getSource()).basicRemove(otherEnd, msgs);
			case CodePackage.TEMPLATE_UNIT__COMMENT:
				return ((InternalEList<?>)getComment()).basicRemove(otherEnd, msgs);
			case CodePackage.TEMPLATE_UNIT__CODE_RELATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CodePackage.TEMPLATE_UNIT__STEREOTYPE:
				return getStereotype();
			case CodePackage.TEMPLATE_UNIT__TAGGED_VALUE:
				return getTaggedValue();
			case CodePackage.TEMPLATE_UNIT__NAME:
				return getName();
			case CodePackage.TEMPLATE_UNIT__SOURCE:
				return getSource();
			case CodePackage.TEMPLATE_UNIT__COMMENT:
