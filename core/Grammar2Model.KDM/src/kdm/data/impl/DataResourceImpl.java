 ...
 * <ul>
 *   <li>{@link kdm.data.impl.DataResourceImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link kdm.data.impl.DataResourceImpl#getTaggedValue <em>Tagged Value</em>}</li>
 *   <li>{@link kdm.data.impl.DataResourceImpl#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public class DataResourceImpl extends ElementImpl implements DataResource {
	/**
	...
	public EList<Stereotype> getStereotype() {
		if (stereotype == null) {
			stereotype = new EObjectResolvingEList<Stereotype>(Stereotype.class, this, DataPackage.DATA_RESOURCE__STEREOTYPE);
		}
		return stereotype;
	}
	...
	public EList<ExtendedValue> getTaggedValue() {
		if (taggedValue == null) {
			taggedValue = new EObjectContainmentEList<ExtendedValue>(ExtendedValue.class, this, DataPackage.DATA_RESOURCE__TAGGED_VALUE);
		}
		return taggedValue;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.DATA_RESOURCE__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DataPackage.DATA_RESOURCE__TAGGED_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataPackage.DATA_RESOURCE__STEREOTYPE:
				return getStereotype();
			case DataPackage.DATA_RESOURCE__TAGGED_VALUE:
				return getTaggedValue();
			case DataPackage.DATA_RESOURCE__NAME:
				return getName();
			case DataPackage.DATA_RESOURCE__SOURCE:
				return getSource();
			case DataPackage.DATA_RESOURCE__DATA_RELATION:
