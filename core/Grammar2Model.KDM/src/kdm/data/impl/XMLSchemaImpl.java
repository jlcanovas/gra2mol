 ...
 * <ul>
 *   <li>{@link kdm.data.impl.XMLSchemaImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link kdm.data.impl.XMLSchemaImpl#getTaggedValue <em>Tagged Value</em>}</li>
 *   <li>{@link kdm.data.impl.XMLSchemaImpl#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public class XMLSchemaImpl extends ElementImpl implements XMLSchema {
	/**
	...
	public EList<Stereotype> getStereotype() {
		if (stereotype == null) {
			stereotype = new EObjectResolvingEList<Stereotype>(Stereotype.class, this, DataPackage.XML_SCHEMA__STEREOTYPE);
		}
		return stereotype;
	}
	...
	public EList<ExtendedValue> getTaggedValue() {
		if (taggedValue == null) {
			taggedValue = new EObjectContainmentEList<ExtendedValue>(ExtendedValue.class, this, DataPackage.XML_SCHEMA__TAGGED_VALUE);
		}
		return taggedValue;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.XML_SCHEMA__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DataPackage.XML_SCHEMA__TAGGED_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataPackage.XML_SCHEMA__STEREOTYPE:
				return getStereotype();
			case DataPackage.XML_SCHEMA__TAGGED_VALUE:
				return getTaggedValue();
			case DataPackage.XML_SCHEMA__NAME:
				return getName();
			case DataPackage.XML_SCHEMA__SOURCE:
				return getSource();
			case DataPackage.XML_SCHEMA__DATA_RELATION:
