 ...
 * <ul>
 *   <li>{@link kdm.platform.impl.BindsToImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link kdm.platform.impl.BindsToImpl#getTaggedValue <em>Tagged Value</em>}</li>
 ...
 * @generated
 */
public class BindsToImpl extends ElementImpl implements BindsTo {
	/**
	...
	public EList<Stereotype> getStereotype() {
		if (stereotype == null) {
			stereotype = new EObjectResolvingEList<Stereotype>(Stereotype.class, this, PlatformPackage.BINDS_TO__STEREOTYPE);
		}
		return stereotype;
	}
	...
	public EList<ExtendedValue> getTaggedValue() {
		if (taggedValue == null) {
			taggedValue = new EObjectContainmentEList<ExtendedValue>(ExtendedValue.class, this, PlatformPackage.BINDS_TO__TAGGED_VALUE);
		}
		return taggedValue;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PlatformPackage.BINDS_TO__TAGGED_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PlatformPackage.BINDS_TO__STEREOTYPE:
