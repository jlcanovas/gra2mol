 ...
 * <ul>
 *   <li>{@link kdm.source.impl.InventoryElementImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link kdm.source.impl.InventoryElementImpl#getTaggedValue <em>Tagged Value</em>}</li>
 *   <li>{@link kdm.source.impl.InventoryElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link kdm.source.impl.InventoryElementImpl#getInventoryRelation <em>Inventory Relation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class InventoryElementImpl extends ElementImpl implements InventoryElement {
	/**
	...
	public EList<Stereotype> getStereotype() {
		if (stereotype == null) {
			stereotype = new EObjectResolvingEList<Stereotype>(Stereotype.class, this, SourcePackage.INVENTORY_ELEMENT__STEREOTYPE);
		}
		return stereotype;
	}
	...
	public EList<ExtendedValue> getTaggedValue() {
		if (taggedValue == null) {
			taggedValue = new EObjectContainmentEList<ExtendedValue>(ExtendedValue.class, this, SourcePackage.INVENTORY_ELEMENT__TAGGED_VALUE);
		}
		return taggedValue;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SourcePackage.INVENTORY_ELEMENT__NAME, oldName, name));
	}
	...
	public EList<AbstractInventoryRelationship> getInventoryRelation() {
		if (inventoryRelation == null) {
			inventoryRelation = new EObjectContainmentEList<AbstractInventoryRelationship>(AbstractInventoryRelationship.class, this, SourcePackage.INVENTORY_ELEMENT__INVENTORY_RELATION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SourcePackage.INVENTORY_ELEMENT__TAGGED_VALUE:
				return ((InternalEList<?>)getTaggedValue()).basicRemove(otherEnd, msgs);
			case SourcePackage.INVENTORY_ELEMENT__INVENTORY_RELATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SourcePackage.INVENTORY_ELEMENT__STEREOTYPE:
				return getStereotype();
			case SourcePackage.INVENTORY_ELEMENT__TAGGED_VALUE:
				return getTaggedValue();
			case SourcePackage.INVENTORY_ELEMENT__NAME:
				return getName();
			case SourcePackage.INVENTORY_ELEMENT__INVENTORY_RELATION:
