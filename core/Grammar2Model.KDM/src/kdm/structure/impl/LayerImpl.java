 ...
 * <ul>
 *   <li>{@link kdm.structure.impl.LayerImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link kdm.structure.impl.LayerImpl#getTaggedValue <em>Tagged Value</em>}</li>
 *   <li>{@link kdm.structure.impl.LayerImpl#getName <em>Name</em>}</li>
...
public class LayerImpl extends ElementImpl implements Layer {
	...
	public EList<Stereotype> getStereotype() {
		if (stereotype == null) {
			stereotype = new EObjectResolvingEList<Stereotype>(Stereotype.class, this, StructurePackage.LAYER__STEREOTYPE);
		}
		return stereotype;
	}
	...
	public EList<ExtendedValue> getTaggedValue() {
		if (taggedValue == null) {
			taggedValue = new EObjectContainmentEList<ExtendedValue>(ExtendedValue.class, this, StructurePackage.LAYER__TAGGED_VALUE);
		}
		return taggedValue;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructurePackage.LAYER__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StructurePackage.LAYER__TAGGED_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StructurePackage.LAYER__STEREOTYPE:
				return getStereotype();
			case StructurePackage.LAYER__TAGGED_VALUE:
				return getTaggedValue();
			case StructurePackage.LAYER__NAME:
				return getName();
			case StructurePackage.LAYER__AGGREGATED:
