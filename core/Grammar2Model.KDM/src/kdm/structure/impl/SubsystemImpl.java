 ...
 * <ul>
 *   <li>{@link kdm.structure.impl.SubsystemImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link kdm.structure.impl.SubsystemImpl#getTaggedValue <em>Tagged Value</em>}</li>
 *   <li>{@link kdm.structure.impl.SubsystemImpl#getName <em>Name</em>}</li>
...
public class SubsystemImpl extends ElementImpl implements Subsystem {
	...
	public EList<Stereotype> getStereotype() {
		if (stereotype == null) {
			stereotype = new EObjectResolvingEList<Stereotype>(Stereotype.class, this, StructurePackage.SUBSYSTEM__STEREOTYPE);
		}
		return stereotype;
	}
	...
	public EList<ExtendedValue> getTaggedValue() {
		if (taggedValue == null) {
			taggedValue = new EObjectContainmentEList<ExtendedValue>(ExtendedValue.class, this, StructurePackage.SUBSYSTEM__TAGGED_VALUE);
		}
		return taggedValue;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructurePackage.SUBSYSTEM__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StructurePackage.SUBSYSTEM__TAGGED_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StructurePackage.SUBSYSTEM__STEREOTYPE:
				return getStereotype();
			case StructurePackage.SUBSYSTEM__TAGGED_VALUE:
				return getTaggedValue();
			case StructurePackage.SUBSYSTEM__NAME:
				return getName();
			case StructurePackage.SUBSYSTEM__AGGREGATED:
