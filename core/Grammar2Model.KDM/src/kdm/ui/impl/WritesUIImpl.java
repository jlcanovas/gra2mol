 ...
 * <ul>
 *   <li>{@link kdm.ui.impl.WritesUIImpl#getStereotype <em>Stereotype</em>}</li>
 *   <li>{@link kdm.ui.impl.WritesUIImpl#getTaggedValue <em>Tagged Value</em>}</li>
 ...
 * @generated
 */
public class WritesUIImpl extends ElementImpl implements WritesUI {
	/**
	...
	public EList<Stereotype> getStereotype() {
		if (stereotype == null) {
			stereotype = new EObjectResolvingEList<Stereotype>(Stereotype.class, this, UiPackage.WRITES_UI__STEREOTYPE);
		}
		return stereotype;
	}
	...
	public EList<ExtendedValue> getTaggedValue() {
		if (taggedValue == null) {
			taggedValue = new EObjectContainmentEList<ExtendedValue>(ExtendedValue.class, this, UiPackage.WRITES_UI__TAGGED_VALUE);
		}
		return taggedValue;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UiPackage.WRITES_UI__TAGGED_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UiPackage.WRITES_UI__STEREOTYPE:
